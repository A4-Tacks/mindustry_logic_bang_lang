...
2. Using the large syntax analysis framework 'lalrpop', which generates nearly 300000 lines of code and works together with 'rustc' to make compilation slower
